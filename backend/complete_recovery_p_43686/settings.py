"""
Django settings for complete_recovery_p_43686 project.
...
ROOT_URLCONF = 'complete_recovery_p_43686.urls'
...
WSGI_APPLICATION = 'complete_recovery_p_43686.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "complete_recovery_p_43686 API",
    "DESCRIPTION": "API documentation for complete_recovery_p_43686 App",
    "VERSION": "v1",
}
